...
(21, 'SuperPlanning', 'Gestion de planning', 'POP SCHOOL', '2021-01-11', '2022-03-15', '2022-03-15'),
(31, 'Projet test 1', 'Projet pour les tests 1', 'Client test 1', '2021-03-01', NULL, '2021-05-01'),
(32, 'Projet test 1', 'Projet pour les tests 1', 'Client test 1', '2021-03-01', NULL, '2021-05-01'),
...
(11, 'Ma Formation DWWM', 'Développeur Web Web Mobile', '2021-10-26', '2022-06-03'),
(12, 'test2', 'Développeur Web Web Mobile', '2021-11-01', '2022-06-03');
...
(90, 2, NULL, 'Étienne', 'Leger', 'etienne.leger@wanadoo.fr', '2021-01-26 19:13:06', '2021-01-26 19:13:06'),
(91, 1, NULL, 'Xavier', 'Barbe', 'xavier.barbe@free.fr', '2021-01-26 05:32:56', '2021-01-26 05:32:56'),
(92, 10, NULL, 'Alex', 'Raynaud', 'alex.raynaud@noos.fr', '2021-01-30 06:02:22', '2021-01-30 06:02:22'),
(93, 9, NULL, 'Yves', 'Meyer', 'yves.meyer@club-internet.fr', '2021-01-26 14:23:58', '2021-01-26 14:23:58'),
(94, 8, NULL, 'Joseph', 'Pires', 'joseph.pires@sfr.fr', '2021-01-31 04:23:27', '2021-01-31 04:23:27'),
(95, 7, NULL, 'David', 'Roger', 'david.roger@hotmail.fr', '2021-01-31 21:43:01', '2021-01-31 21:43:01'),
(96, 6, NULL, 'Nathalie', 'Petitjean', 'nathalie.petitjean@laposte.net', '2021-01-28 10:55:50', '2021-01-28 10:55:50'),
(97, 5, NULL, 'Mathilde', 'Meyer', 'mathilde.meyer@dbmail.com', '2021-01-28 03:28:54', '2021-01-28 03:28:54'),
...
--
ALTER TABLE `project_tag`
  ADD CONSTRAINT `FK_91F26D60166D1F9C` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_91F26D60BAD26311` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
