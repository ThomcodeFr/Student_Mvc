  ...
  <header>
    <div class="container">
      <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        <a href="http://localhost:8888/student_mvc/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
          <h3>BDD - Etudiants</h3>
        </a>

        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          <li><a href="http://localhost:8888/student_mvc/" class="nav-link px-2 link-secondary">Home</a></li>
        ...
        <form method="GET" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
          <input type="search" name="research" class="form-control form-control-dark" placeholder="Recherche : étudiant.e / tag ..." aria-label="Search">
        </form>
